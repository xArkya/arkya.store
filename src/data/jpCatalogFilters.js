...
export const JP_PRICE_BANDS = [
  { range: '-300', label: '~$15–35 mil' },
  { range: '301-700', label: '~$15–45 mil' },
  { range: '701-1200', label: '~$25–45 mil' },
  { range: '1201-2500', label: '~$35–70 mil' },
  { range: '2501-5000', label: '~$55–100 mil' },
  { range: '5001-', label: 'desde ~$90 mil' },
];
