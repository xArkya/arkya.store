      ...
      <Box bg="#453641" flex="1">
        <Container maxW="1100px" py={8} px={{ base: 4, md: 8 }}>
          ...
          <Text color="gray.400" fontSize="md">
            ¿Qué tan buen ojo tienes? Adivina el anime a través de las imágenes pixeladas.
          </Text>
        </Box>
                    ...
                    {GAME_LEVELS.map((level, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Text fontSize="md" fontWeight="extrabold" color={`${scheme}.300`} mt={1}>
                    ...
                    <VStack spacing={4} w="100%" maxW="400px">
                      <Box w="100%">
                        <Text fontSize="sm" color="gray.400" mb={2} textAlign="left">
                          Tu Instagram o email (para contactarte si ganás):
                        </Text>
                        <Input
                          placeholder="Ej: @tu_usuario o mail@ejemplo.com"
                          value={userName}
                          ...
                          _focus={{ borderColor: 'pink.300', boxShadow: '0 0 0 1px pink.300' }}
                        />
                      </Box>
                      <Button
                        size="lg"
            ...
            >
              ...
              <Box textAlign="center">
                ...
                <Text fontSize="sm" color="gray.500" mt={2}>
                  Dificultad: {'⭐'.repeat(Math.min(currentLevelIndex + 1, 5))}
                </Text>
              </Box>
              ...
              <VStack spacing={4} align="stretch">
                <Input
                  ...
                  py={6}
                />
                <Flex direction={{ base: 'column-reverse', md: 'row' }} gap={3} w="100%" align="center">
                  <Button
                    size="sm"
                    variant="ghost"
                    color="gray.400"
              ...
              <CardBody p={{ base: 6, md: 10 }}>
                <VStack spacing={6}>
                  ...
                  <Text fontSize="md" color="gray.300" textAlign="center">
                    Tus respuestas fueron enviadas. El admin las revisará y te contactará con el descuento que te corresponda.
                  </Text>
                    ...
                    <VStack spacing={3} align="stretch">
                      {answers.map((ans, idx) => {
                        ...
                        return (
                          ...
                          >
                            <HStack spacing={3}>
                              <Badge colorScheme={scheme} variant="solid" px={2} py={1} borderRadius="md">
                                {ans.levelName}
                              </Badge>
                              <Box>
                  ...
                  <Box
                    ...
                    textAlign="center"
                  >
                    <Icon as={FaCheckCircle} fontSize="3xl" color="green.400" mb={3} />
                    <Heading size="md" color="green.300" mb={2}>
                      ¡Respuestas enviadas!
                    </Heading>
                    <Text color="gray.300">
                      Gracias por participar. Te contactaremos por {userName} cuando se revelen las respuestas.
                    </Text>
                  </Box>
